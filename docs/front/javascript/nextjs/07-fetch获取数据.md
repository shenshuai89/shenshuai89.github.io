...
![image.png](/assets/images/nextjs/07-1image.png)
让我们继续导入更多的数据查询！
...
![image.png](/assets/images/nextjs/07-2image.png)
## 获取Card组件数据
...
![image.png](/assets/images/nextjs/07-3image.png)
然而您需要注意两件事：
...
![image.png](/assets/images/nextjs/07-4image.png)
